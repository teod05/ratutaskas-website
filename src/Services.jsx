        ...
        <div id="services" className="services-section">
            <div className="services-container">
                <div className="services-header">
                    <h2>Mūsų <span className="paslaugos">Paslaugos</span></h2>
                    <p>Profesionalios padangų priežiūros paslaugos Klaipėdoje</p>
                </div>
                
                <div className="services-layout">
                    {/* Main Featured Service */}
                    <div className="service-main featured">
                    ...
                    <div className="services-secondary">
                        {/* Padangų Remontas */}
                        <div className="service-main small">
                            <div className="service-image">
                                <img src="./src/assets/ChatGPT Image Jun 18, 2025, 01_42_07 PM.png" alt="Padangų remontas" />
                            </div>
                            <div className="service-content">
                        ...
                        <div className="service-main small">
                            <div className="service-image">
                                <img src="./src/assets/IMG_2626.JPG" alt="Padangų saugojimas" />
                            </div>
                            <div className="service-content">
                                <h3>Padangų Saugojimas</h3>
                                <p>Saugus padangų saugojimas mūsų sandėlyje. Apsauga nuo žalos ir ilgesnis padangų tarnavimo laikas.</p>
                            </div>
                        </div>
                    </div>
                </div>
